                ...
                <div class="inner">
                    <div class="row">
                        <div class="col-lg-12 page_title_head">
                            <h1>Add Location/Stadium</h1>
                            <p>Add new location or stadium to add schedule.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(array('url' => 'save_stadium', 'method' => 'post', 'class' => 'form-horizontal bordered-row')) !!}
                                    <div class="form-group team_name">
                                        <label class="col-sm-3 control-label">Stadium Name <i class="color_red">*</i></label>
                                        <div class="col-sm-6 input_wrap">
                                            <div class="name_wrap">
                                                <input type="text" placeholder="Stadium Name..." name='stadium_name[]' class="form-control">
