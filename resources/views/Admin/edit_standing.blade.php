                        ...
                        <div class="col-lg-12">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    {!! Form::open(array('url' => 'update_standing/'.$standingData->id, 'method' => 'post', 'class' => 'form-horizontal bordered-row')) !!}
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Standing Name <i class="color_red">*</i></label>
                                        <div class="col-sm-6">
                                            <input type="text" value="{{$standingData->standing_name}}" placeholder="Standing Name..." name='standing_name' class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" name="category">
                                                ...
                                                <?php
                                                $selected = '';
                                                if($standingData->category_id == $cat->id){
                                                    $selected = 'selected="selected"';
                                                }
                                                ?>
                                                <option <?php echo $selected; ?> value="{{$cat->id}}">{{$cat->category_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
